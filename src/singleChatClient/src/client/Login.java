...
public class Login extends JFrame {
	...
	public Login() {
		...
		img.setIcon(new ImageIcon(new ImageIcon("D:\\Monhoc\\laptrinhjava\\thihockyjava\\img\\firebase-chat-app.png").getImage().getScaledInstance(200, 200, Image.SCALE_SMOOTH)));
